...
object Stream { self =>
  ...
  implicit class StreamOps[F[_], A](val self: Stream[F, A]) extends AnyVal {
     ...
     *
     * @param f
     *   Converts a last stream element, to a stream of output elements to be emitted after all
